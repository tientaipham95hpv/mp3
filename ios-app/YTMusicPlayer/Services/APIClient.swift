...
public class APIClient: ObservableObject {
    ...
    // Default production backend URL with persistent storage
    ...
    public init() {
        self.baseURL = UserDefaults.standard.string(forKey: "custom_backend_url") ?? "https://mp3-two-swart.vercel.app"
    }
